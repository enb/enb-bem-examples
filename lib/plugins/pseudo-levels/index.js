...
module.exports = function (helper) {
    return {
            ...
            helper.prebuild(function (magic) {
                ...
                return pseudo(options.levels)
                    ...
                    .then(function (filenames) {
                        ...
                        _this._copySymlinks(config, Object.keys(nodes), options);
                        _this._registerTargets(magic, channel, options, root, filenames);
                    });
            });
        },

        _copySymlinks: function (config, nodes, options) {
        ...
        _registerTargets: function (magic, channel, options, root, filenames) {
            var nodes = {};
