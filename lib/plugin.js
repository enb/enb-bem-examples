...
module.exports = function (taskConfigurator) {
    var pseudoConfigurator = pseudoLevelsPlugin(taskConfigurator);
    var inlineConfigurator = inlineBemjsonPlugin(taskConfigurator);
    ...
    return {
        ...
        configure: function (options) {
            ...
            options.levels = options.levels.map(function (level) {
