...
module.exports = function (taskConfigutator) {
    return {
        configure: function (options) {
            this._configurePseudoLevels(options);
            this._configureNodes(options);
            this._configureInlineBemjson(options);
        },

        _configurePseudoLevels: function (options) {
        ...
        _configureInlineBemjson: function (options) {
            if (options.inlineBemjson) {
                ...
                var processBemjson = options.processBemjson || function (bemjson) {
                    return bemjson;
                };
                                ...
                                return getExamplesFromMdFile(filename, dstpath)
                                    ...
                                    .then(function (examples) {
                                        return vow.all(examples.map(function (example) {
                                            ...
                                            example = processExample(example, processBemjson);
